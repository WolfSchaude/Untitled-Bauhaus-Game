...
public class Kamera : MonoBehaviour
{
	...
	[SerializeField] public static UnityEvent LockCameraMovement;
	[SerializeField] public static UnityEvent FreeCameraMovement;
	...
	void Start()
	{
		...
		{
			LockCameraMovement = new UnityEvent();
			LockCameraMovement.AddListener(() => { LockMovement(); });
		}
	...
	/// <summary>
	/// This function sets AbletoMove to false, restricting Camera Movements
	/// </summary>
