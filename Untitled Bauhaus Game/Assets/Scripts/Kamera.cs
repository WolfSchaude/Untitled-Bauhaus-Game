    ...
    public class Kamera : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            if (AbleToMove)
            {
                ...
                if (((d > 0f && Input.GetKey(KeyCode.Mouse1) ) || Input.GetKeyDown(KeyCode.Space)) && height < 25)
                {
                    height++;
                }
                else if (((d < 0f && Input.GetKey(KeyCode.Mouse1)) || Input.GetKeyDown(KeyCode.LeftControl)) && height > 3)
                {
                    height--;
                }
            }
