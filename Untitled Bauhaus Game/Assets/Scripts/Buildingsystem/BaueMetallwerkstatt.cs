...
public class BaueMetallwerkstatt : MonoBehaviour
{
	public int studKapazitätMetall = 200;
	public int AktPreis = 1000;
	public int metallBuildTimeInMonths = 2;
	...
	public void NeueMetallwerkstatt()
	{
		if (!buildInProgress)
		{
